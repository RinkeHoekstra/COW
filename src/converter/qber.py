...
from rdflib import URIRef, Dataset, Literal, Graph, RDF, Namespace

from src.converter.util import Nanopublication, DatastructureDefinition, apply_default_namespaces

from src.converter.util.namespaces import FOAF, PROV, QB

logger = logging.getLogger(__name__)
ch = logging.StreamHandler()


# QBer has its own SDR and SDV
SDR = Namespace("https://iisg.nl/")
SDV = Namespace("https://iisg.nl/vocab/")
...
class Profile(Graph):
    ...
    def __init__(self, profile):
        ...
        self.author_uri = SDR["person/" + urllib.quote_plus(profile['email'])]
